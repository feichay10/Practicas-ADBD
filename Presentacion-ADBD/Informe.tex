...
La práctica de salvaguardar equipos, redes, aplicaciones de software, sistemas críticos y datos de amenazas digitales potenciales se conoce como ciberseguridad. A las organizaciones les incumbe la responsabilidad de resguardar la integridad de los datos con el fin de preservar la confianza de los clientes y cumplir con las normativas establecidas. Con el empleo de medidas y herramientas de ciberseguridad, se busca prevenir el acceso no autorizado a datos confidenciales y evitar interrupciones en las operaciones empresariales derivadas de actividades de red no deseadas. La implementación de la ciberseguridad por parte de las organizaciones se lleva a cabo mediante la optimización de la defensa digital, involucrando a las personas, los procesos y las tecnologías.
